library rameez_flutter_login_teddy;
...
class FlutterTeddyLoginRameez {
  final IconData icon;
  final String label;
  final ProviderAuthCallback callback;

  FlutterTeddyLoginRameez(
      {required this.icon, required this.callback, this.label = ''});
}
...
class FlutterLogin extends StatefulWidget {
  FlutterLogin(
      ...
      this.loginProviders = const <FlutterTeddyLoginRameez>[],
  ...
  final List<FlutterTeddyLoginRameez> loginProviders;
